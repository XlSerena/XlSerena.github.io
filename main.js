const copy = {
  en: {
    ...
    side_lede:
      "A quieter thread: games, XR, and playful systems I still care about—kept light so the main work stays primary.",
    ...
    side_si659_blurb:
      "A Unity + Meta SDK field drill: map a ruined zone, plan a route, and set up under pressure—built for Quest Pro controllers.",
    side_si659_role: "Development · Unity / Meta SDK · interactions & field UI",
    side_game_time: "Spring 2024",
    side_game_title: "The Time Gambit",
    side_game_blurb:
      "A chess-pawn’s quest across two eras: swap past and present to solve the path forward.",
    side_game_role: "Game mechanics · level design · art · main menu",
  ...
  zh: {
    ...
    side_kicker: "旁支",
    side_title: "值得留下的小实验。",
    side_lede: "另一条安静的线：游戏、XR 与有趣的交互——占位克制，不抢主线作品。",
    ...
    side_si659_blurb:
      "Unity + Meta SDK 现场演习：在废墟中用地图规划路线、布置报道设备——为 Quest Pro 手柄打造。",
    side_si659_role: "开发 · Unity / Meta SDK · 交互与现场 UI",
    side_game_time: "2024 春",
    side_game_title: "The Time Gambit",
    side_game_blurb: "小兵穿越两个时代：在过去与现在之间切换，解开前路的谜题。",
    side_game_role: "游戏机制 · 关卡设计 · 美术 · 主菜单",
    contact_kicker: "联络",
    contact_title: "保持联络。",
