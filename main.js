const copy = {
  en: {
    ...
    cta_mail: "Email",
    about_kicker: "About",
    about_title: "Agents and infrastructure that hold under production load.",
    about_body:
      "I build where models meet durable infrastructure—production agents, trustworthy data paths, and AI spend you can govern. AI Platform & Infrastructure Engineer at Noematrix (Flexiv Robotics); previously Data Engineer Intern at TikTok. M.S. Information (Big Data Analytics), University of Michigan; B.Eng. ECE, Shanghai Jiao Tong University.",
    about_list: [
  ...
  zh: {
    ...
    cta_mail: "邮件",
    about_kicker: "关于",
    about_title: "扛得住生产负载的智能体与基础设施。",
    about_body:
      "我在大模型与可靠基础设施的交界处做事——生产级智能体、可信数据路径，以及可治理的 AI 花销。现任 Noematrix（Flexiv Robotics）AI 平台与基础设施工程师；曾于 TikTok 任数据工程实习生。密歇根大学信息学院硕士（大数据分析）；上海交通大学电子与计算机工程学士。",
    about_list: [
