const copy = {
  en: {
    ...
    side_lede:
      "Games, XR, and playful systems where design meets tech—kept light so the main work stays primary.",
    ...
    side_si659_blurb:
      "A Quest Pro XR drill for journalists: read the field map, pick a route, and set up in a disaster zone—built in Unity with the Meta SDK.",
    side_si659_role: "Dev · Unity + Meta SDK · interactions & spatial UI",
  ...
  zh: {
    ...
    side_kicker: "旁支",
    side_title: "值得留下的小实验。",
    side_lede: "游戏、XR 与可玩系统：设计、艺术与科技的交界——占位克制，不抢主线作品。",
    ...
    side_si659_blurb:
      "面向记者的 Quest Pro XR 演习：在灾区读地图、选路线、布置报道设备——Unity + Meta SDK 实现。",
    side_si659_role: "开发 · Unity + Meta SDK · 交互与空间 UI",
